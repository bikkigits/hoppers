...
class _MapScreenState extends State<MapScreen> {
  ...
  final Map<String, Map<String, String>> _dict = {
    ...
    'hi': {
      ...
      'suggest_desc': 'एक तस्वीर लेने के लिए अपने लाइव कैमरे का उपयोग करें और तुरंत एक नए पंडाल को मैप करें!',
      'pandal_name': 'पंडाल का नाम', 'submit': 'रिव्यु के लिए सबमिट करें', 'attach_photo': 'लाइव फोटो लें (अनिवार्य)', 'photo_attached': 'फोटो जुड़ गई!',
    ...
    'bn': {
      ...
      'suggest_desc': 'একটি ছবি তুলতে আপনার লাইভ ক্যামেরা ব্যবহার করুন এবং অবিলম্বে একটি নতুন প্যান্ডেল ম্যাপ করুন!',
      'pandal_name': 'প্যান্ডেলের নাম', 'submit': 'রিভিউয়ের জন্য জমা দিন', 'attach_photo': 'লাইভ ছবি নিন (প্রয়োজনীয়)', 'photo_attached': 'ছবি যুক্ত হয়েছে!',
          ...
          child: GestureDetector(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: isNight 
                    ? [BoxShadow(color: _getColorForCategory(cat, isVisited).withOpacity(0.8), blurRadius: 15, spreadRadius: 3)] 
                    : [BoxShadow(color: _getColorForCategory(cat, isVisited).withOpacity(0.5), blurRadius: 6, spreadRadius: 1)]
              ),
              child: Icon(
                isVisited && cat == 'pandal' ? Icons.check : _getIconForCategory(cat), 
                color: Colors.white, 
                size: iconSize
              ),
            ),
                  ...
                  child: ListView(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: const BoxDecoration(
                          gradient: LinearGradient(colors: [Color(0xFFD84315), Color(0xFFFF8A65)], begin: Alignment.topLeft, end: Alignment.bottomRight), 
                          borderRadius: BorderRadius.vertical(top: Radius.circular(24))
                        ), 
                        child: Column(
                          children: [
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(name, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, height: 1.2, color: Colors.white)), 
                                      const SizedBox(height: 4), 
                                      Text('📍 $distanceText', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.white70))
                                    ]
                                  )
                                )
                              ]
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    crossAxisAlignment: CrossAxisAlignment.start, 
                                    children: [
                                      const Icon(Icons.category, size: 18, color: Color(0xFFD84315)), 
                                  ...
                                  if (theme.isNotEmpty) ...[
                                    ...
                                    Row(
                                      crossAxisAlignment: CrossAxisAlignment.start, 
                                      children: [
                                        const Icon(Icons.palette, size: 18, color: Color(0xFFD84315)), 
                                        const SizedBox(width: 8), 
                                  ...
                                  if (nearestMetro.isNotEmpty) ...[
                                    ...
                                    Row(
                                      crossAxisAlignment: CrossAxisAlignment.start, 
                                      children: [
                                        const Icon(Icons.subway, size: 18, color: Colors.blue), 
                                        const SizedBox(width: 8), 
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              children: [
                                                const Icon(Icons.update, size: 12, color: Colors.red), 
                                    ...
                                    setState(() {
                                      if (isVisited) { 
                                        ...
                                        if (_visitedPandals.length % 3 == 0) { 
                                          ...
                                          _showAchievementPopup('Passport Updated! 🏆', 'Great! $name has been stamped in your Hopper Passport.', Icons.stars, const Color(0xFFD84315)); 
                                        } 
                                      }
                                    }); 
                                    setSheetState(() {}); 
      ...
      builder: (ctx) { 
        return AlertDialog(
          ...
          content: Column(
            mainAxisSize: MainAxisSize.min, 
            children: [
              Text(pandalName, style: const TextStyle(color: Color(0xFFD84315), fontWeight: FontWeight.bold, fontSize: 14)), 
      ...
      builder: (context) { 
        return Container(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min, 
            children: [
              Row(children: [const Icon(Icons.route, color: Color(0xFFD84315), size: 28), const SizedBox(width: 8), Text('🗺️ ${getText('trails')}', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold))]), 
              const Divider(height: 20), 
                ...
                return Card(
                  ...
                  child: ListTile(
                      ...
                      children: [
                        ...
                        if (trail.isOneWay) ...[
                          ...
                          Container(
                            ...
                            child: Text(getText('one_way'), style: const TextStyle(fontSize: 10, color: Colors.red, fontWeight: FontWeight.bold))
                          )
                        ]
                      ]
                    ), 
                    ...
                    onTap: () { 
                      ...
                      if (trail.isOneWay) { 
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(getText('one_way_desc'), style: const TextStyle(fontWeight: FontWeight.bold)), backgroundColor: Colors.red.shade800, duration: const Duration(seconds: 4))); 
                      } 
                    }
                  )
                ); 
      ...
      builder: (context) { 
        return StatefulBuilder(
          builder: (context, setDialogState) { 
            return AlertDialog(
              backgroundColor: Colors.white, 
              title: Row(children: [const Icon(Icons.military_tech, color: Color(0xFFD84315), size: 28), const SizedBox(width: 8), Text(getText('passport'), style: const TextStyle(fontSize: 18))]), 
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 15), 
                    Text('🏆 ${getText('achievements')} ($visitedCount)', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: const Color(0xFFD84315))), 
                    const SizedBox(height: 10), 
                    Row(
              ...
              actions: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () { 
                    _updateProfile(nameController.text.trim().isEmpty ? 'Pujo Hopper' : nameController.text.trim(), selectedAvatar); 
                    Navigator.pop(context); 
                  }, 
    ...
    return Column(
      children: [
        Container(
          ...
          decoration: BoxDecoration(color: isUnlocked ? Colors.orange.shade100 : Colors.grey.shade200, shape: BoxShape.circle, border: Border.all(color: isUnlocked ? const Color(0xFFD84315) : Colors.grey, width: 2)), 
          child: Icon(isUnlocked ? Icons.verified : Icons.lock, color: isUnlocked ? const Color(0xFFD84315) : Colors.grey, size: 20)
        ), 
        const SizedBox(height: 4), 
                ...
                child: Column(
                  ...
                  children: [
                    DropdownButtonFormField<String>(
                      isExpanded: true, 
                      decoration: InputDecoration(labelText: getText('from_stn'), border: const OutlineInputBorder()), 
                      value: selectedFrom, 
                      items: _allStations.map((s) => DropdownMenuItem(value: s, child: Text(_getStationWithEmoji(s)))).toList(), 
                      onChanged: (val) => setDialogState(() { selectedFrom = val; routeResult = ''; })
                    ), 
                    const SizedBox(height: 10), 
                    DropdownButtonFormField<String>(
                      isExpanded: true, 
                      decoration: InputDecoration(labelText: getText('to_stn'), border: const OutlineInputBorder()), 
                      value: selectedTo, 
                      items: _allStations.map((s) => DropdownMenuItem(value: s, child: Text(_getStationWithEmoji(s)))).toList(), 
                    ...
                    if (routeResult.isNotEmpty) 
                      Container(
                        ...
                        child: Text(routeResult, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, height: 1.4))
                      )
                  ]
                )
              ), 
                ...
                ElevatedButton(
                  ...
                  onPressed: () { 
                    if (selectedFrom != null && selectedTo != null) {
                      setDialogState(() { routeResult = 'Route logic bypassed for brevity.'; }); 
                    }
                  }, 
          ...
          builder: (context, scrollController) { 
            return Container(
              ...
              child: ListView(
                ...
                children: [
                  Row(children: [const Icon(Icons.directions_transit, color: Color(0xFFD84315), size: 28), const SizedBox(width: 10), Text(getText('transit'), style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFFD84315)))]), 
                  const Divider(height: 20), 
                  ElevatedButton.icon(
                    ...
                    label: Text(getText('open_router'), style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold))
                  ), 
                  const SizedBox(height: 20), 
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10), 
              SizedBox(width: double.infinity, child: ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Colors.red, foregroundColor: Colors.white), onPressed: () => Navigator.pop(context), child: Text(getText('close'))))
            ]
          )
        ); 
      }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      OutlinedButton.icon(
                        ...
                        icon: const Icon(Icons.photo_camera, color: Color(0xFFD84315)), 
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? const Color(0xFFD84315) : (isNight ? Colors.grey.shade900.withOpacity(0.8) : Colors.white.withOpacity(0.9)), 
            borderRadius: BorderRadius.circular(20), 
            border: Border.all(color: isSelected ? const Color(0xFFD84315) : (isNight ? Colors.grey.shade700 : Colors.grey.shade300)), 
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        flexibleSpace: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [const Color(0xFFD84315), isNight ? const Color(0xFF8E24AA) : const Color(0xFFFF8A65)], 
        ...
        title: Row(
          children: [
            GestureDetector(
              ...
              child: CircleAvatar(backgroundColor: Colors.white, child: Text(_userAvatar, style: const TextStyle(fontSize: 18)))
            ), 
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start, 
                children: [
                  Text(_userName, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis), 
                  Text('${_visitedPandals.length} ${getText('visited')}', style: const TextStyle(fontSize: 11, color: Colors.white70))
                ]
              )
            )
          ]
        ...
        child: Column(
          children: [
            UserAccountsDrawerHeader(
              ...
              currentAccountPicture: CircleAvatar(backgroundColor: Colors.white, child: Text(_userAvatar, style: const TextStyle(fontSize: 24))), 
              decoration: const BoxDecoration(gradient: LinearGradient(colors: [Color(0xFFD84315), Color(0xFFFF8A65)]))
            ),
            ...
            const Spacer(), 
            const Divider(),
            ListTile(leading: const Icon(Icons.install_mobile, color: Colors.green), title: const Text('Add to Homescreen', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.green)), subtitle: const Text('Get the full app experience', style: TextStyle(fontSize: 12)), onTap: () { Navigator.pop(context); _showInstallPrompt(); }), 
            const SizedBox(height: 20),
          ],
        ),
      ),
        ...
        children: [
          ...
          FlutterMap(
            ...
            options: const MapOptions(
              initialCenter: LatLng(22.5650, 88.3620), 
              initialZoom: 12.5
            ), 
            children: [
              ...
              ColorFiltered(
                colorFilter: isNight 
                    ...
                    : (isGoldenHour ? const ColorFilter.matrix(InvertColorMatrix.dimFilter) : const ColorFilter.mode(Colors.transparent, BlendMode.multiply)),
                child: TileLayer(
                  urlTemplate: tileUrl, 
                  userAgentPackageName: 'com.bikki.hoppers', 
              ...
              children: [
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Icon(Icons.search, color: isNight ? Colors.white54 : Colors.grey.shade600), 
                        const SizedBox(width: 10),
                        Expanded(
                          child: TextField(
                            controller: _searchController, 
                            style: TextStyle(color: isNight ? Colors.white : Colors.black87), 
                            decoration: InputDecoration(hintText: getText('search_hint'), hintStyle: TextStyle(color: isNight ? Colors.white54 : Colors.grey.shade600), border: InputBorder.none)
                          )
                        ),
                        if (_searchController.text.isNotEmpty) 
                          IconButton(icon: Icon(Icons.clear, color: isNight ? Colors.white54 : Colors.grey.shade600), iconSize: 20, onPressed: () { _searchController.clear(); FocusScope.of(context).unfocus(); }),
                        Container(
                          margin: const EdgeInsets.all(4), 
                          decoration: BoxDecoration(gradient: const LinearGradient(colors: [Color(0xFFD84315), Color(0xFFFF8A65)]), borderRadius: BorderRadius.circular(25)), 
                          child: IconButton(icon: const Text('✨', style: TextStyle(fontSize: 18)), onPressed: _triggerDestiny, tooltip: 'Select Destiny')
                        )
                      ],
                    ),
                  ),
                ...
                if (_isSearching && _searchResults.isNotEmpty)
                  Container(
                    ...
                    decoration: BoxDecoration(color: isNight ? Colors.grey.shade900 : Colors.white, borderRadius: BorderRadius.circular(15), boxShadow: const [BoxShadow(color: Colors.black26, blurRadius: 10)]),
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          leading: const Icon(Icons.temple_hindu, color: Color(0xFFD84315)), 
                          title: Text(item['name'], style: TextStyle(color: isNight ? Colors.white : Colors.black87, fontWeight: FontWeight.bold)), 
                          subtitle: Text(item['theme'] ?? '', style: TextStyle(fontSize: 11, color: isNight ? Colors.white54 : Colors.grey.shade600), maxLines: 1, overflow: TextOverflow.ellipsis), 
                          onTap: () { 
                            FocusScope.of(context).unfocus(); 
                            _searchController.clear(); 
